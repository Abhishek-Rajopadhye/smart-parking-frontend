  ...
  */
    ...
    try {
      ...
      if (flag) {
        const response = await axios.put(
          `${BACKEND_URL}/bookings/update-booking-slots`,
          {
  ...
  const handleCancel = async () => {
	...
	return (
      ...
      <ConfirmationDialogBox open={dialogBookingOpen} message={msg} onConfirm={processPayment} onCancel={handleCancel}></ConfirmationDialogBox>
		</Box>
	);
};
